...
async def search_entity(term: str = Query(..., description="The ontology term to search for."),
                        ...
                        limit: Optional[int] = Query(2, description="The maximum number of search results to return."), 
                        offset: Optional[int] = Query(1, description="Offset for pagination of results")) -> SearchResultItems:

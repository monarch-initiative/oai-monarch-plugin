...
class SearchResultItem(BaseModel):
    id: str = Field(
        ..., description="The ontology identifier of the search result.", example="MONDO:0009061"
    )
    name: str = Field(..., description="The name of the search result.", example="cystic fibrosis")
    categories: List[str] = Field(
        ..., description="The categories of the search result.", example=["biolink:Disease"]
    )
...
async def search_entity(
    term: str = Query(..., description="The ontology term to search for."),
